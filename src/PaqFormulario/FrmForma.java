 ...
 * @author Danny Veron
 */
public final class FrmForma extends javax.swing.JDialog {
     ...
     */
    public FrmForma(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        botonEnter();
        centrar();
        ...
        try {
            ...
            if (rs.next() == true) {
                ...
                while (rs.next()) {
                    ...
                    Nombre = rs.getString("pag_descripcion");
            ...
            Logger.getLogger(FrmForma.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnAgrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgrActionPerformed
        try {
            botonagregar = true;
            String sql = "Select ifnull(max(pag_codigo),0)+1 codigo From forma_pago";
            //System.out.println(sql);
            conexion();
            rs = con.Consulta(sql);
            rs.next();
...
//        this.txtCod.grabFocus();
        ...
        if (res == JOptionPane.OK_OPTION) {
            try {
                ...
                if (botonagregar == true) {
                    ...
                    String sql = "INSERT INTO forma_pago (pag_codigo,pag_descripcion)"
                ...
                if (botonmodificar == true) {
                    conexion();
                    String update = "UPDATE forma_pago SET "
                            + "pag_descripcion='" + this.txtNom.getText()
                            + "' WHERE pag_codigo=" + this.txtCod.getText();
    ...
    private void txtCodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCodActionPerformed
        String sql1 = "SELECT * FROM forma_pago WHERE  pag_codigo=" + txtCod.getText();
                ...
                if (botonmodificar == true) {
                    try {
                        String sql = "Select * FROM forma_pago "
                                + "WHERE pag_codigo=" + txtCod.getText();
                        //System.out.println(sql);
                        rs = con.Consulta(sql);
                        rs.next();
                        txtNom.setText(rs.getString("pag_descripcion"));
                        txtNom.setEnabled(true);
                        txtNom.grabFocus();
                    } catch (SQLException ex) {
                        Logger.getLogger(FrmForma.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void txtNomFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNomFocusLost
        String sql = "SELECT * FROM forma_pago WHERE pag_descripcion='" + txtNom.getText() + "'";
    ...
    private void TablaCatedraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaCatedraMouseClicked
        try {
            conexion();
            String sql = "Select * FROM forma_pago "
                    + "WHERE pag_codigo=" + TablaCatedra.getValueAt(TablaCatedra.getSelectedRow(), 0);
            System.out.println(sql);
            rs = con.Consulta(sql);
            if (rs.next()) {
                txtCod.setText(rs.getString("pag_codigo"));
                txtNom.setText(rs.getString("pag_descripcion"));
            }
            con.CerrarConexion();
        } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FrmForma dialog = new FrmForma(new javax.swing.JDialog(), true);
